...
class educationservices(models.Model):
    educationservices = models.CharField(max_length=100)

    def __str__(self):
        return self.educationservices

    def save_educationservices(self):
        self.save()

    @classmethod
    def delete_educationservices(cls,educationservices):
        cls.objects.filter(educationservices=educationservices).delete()

class Education(models.Model):
    logo = models.ImageField(upload_to='educationlogo/')
    neighbourhood = models.ForeignKey(neighbourhood,on_delete=models.CASCADE)
    name =models.CharField(max_length=100)
    email = models.EmailField()
    contact = models.IntegerField()
